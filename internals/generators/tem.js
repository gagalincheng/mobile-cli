...
const moduleHelper = require('../utils/module');
...
module.exports = {
  ...
  prompts: [{
    ...
    default: 'app',
    choices: () => moduleHelper.getModules(),
  }, {
    type: 'list',
    name: 'name',
    ...
    choices: (props) => {
      ...
      var currentActions = moduleHelper.getActions(props.module);
    ...
    choices: (props) => {
      ...
      var currentReducers = moduleHelper.getReducers(props.module);
  ...
  actions: (data) => {
    ...
    if(data.name === 'create a action'){
      const actionTemplate = fs.readFileSync(path.join(__dirname, './actions.file.js.hbs'), 'utf8')
    ...
    const actionContentTemplate = fs.readFileSync(path.join(__dirname, './actions.content.js.hbs'), 'utf8')
