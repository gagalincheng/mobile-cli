...
const config = require('../dll.config');
...
const dllFiles = fs.readdirSync(outputPath);
dllFiles.forEach(function(item){
...
exec('cross-env BUILDING_DLL=true webpack --display-chunks --color --config internals/webpack/webpack.dll.babel.js --mode production --hide-modules');
